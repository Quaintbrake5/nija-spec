...
describe('PatchGenerator', () => {
    it('should generate patch for BREACH-001', () => {
        ...
        const patch = patchGenerator_1.PatchGenerator.generatePatch('BREACH-001', data);
    ...
    it('should generate patch for BREACH-002', () => {
        const patch = patchGenerator_1.PatchGenerator.generatePatch('BREACH-002', {});
    ...
    it('should generate generic patch for unknown breach ID', () => {
        const patch = patchGenerator_1.PatchGenerator.generatePatch('BREACH-999', {});
    ...
    it('should generate patch for BREACH-003', () => {
        const patch = patchGenerator_1.PatchGenerator.generatePatch('BREACH-003', {});
    ...
    it('should generate patch for BREACH-004 with Foreign residency', () => {
        ...
        const patch = patchGenerator_1.PatchGenerator.generatePatch('BREACH-004', data);
    ...
    it('should generate patch for BREACH-005', () => {
        const patch = patchGenerator_1.PatchGenerator.generatePatch('BREACH-005', {});
        expect(patch).toContain('MFA');
        expect(patch).toContain('CBN');
        expect(patch).toContain('4.1');
    });
    it('should generate patch for BREACH-006', () => {
        const patch = patchGenerator_1.PatchGenerator.generatePatch('BREACH-006', {});
